fileID=fopen('truepositivechiUDPnorandomnoVuze.txt','a+');
fileID1=fopen('falsepositivechiUDPnorandomnoVuze.txt','a+');
%for i=1:15
[lab,data]=libsvmread('trafficchiUDPnorandomnoVuze.scale.txt');
[~,~,label]=unique(lab);
numlabel=max(label);
