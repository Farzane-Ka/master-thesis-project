fileID=fopen('truepositivechiTUDPnorandom500.txt','a+');
fileID1=fopen('falsepositivechiTUDPnorandom500.txt','a+');
%for i=1:15
[lab,data]=libsvmread('trafficchiTUDPnorandom500.scale.txt');
[~,~,label]=unique(lab);
numlabel=max(label);
