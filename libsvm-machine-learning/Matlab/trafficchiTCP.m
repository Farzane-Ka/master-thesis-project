fileID=fopen('truepositivechiTCPnorandomnoVuze.txt','a+');
fileID1=fopen('falsepositivechiTCPnorandomnoVuze.txt','a+');
%for i=1:5
[lab,data]=libsvmread('trafficchiTCPnotrandomNoVuze.scale.txt');
[~,~,label]=unique(lab);
numlabel=max(label);
